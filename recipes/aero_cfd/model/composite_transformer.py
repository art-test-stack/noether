...
class CompositeTransformer(CompositeModel):
    ...
    def __init__(self, model_config: CompositeTransformerConfig, **kwargs):
        """
        Args:
            model_config: The model configuration used to initialize the model. See :class:`~aero_cfd.schemas.models.composite_transformer_config.CompositeTransformerConfig` for available options."""
