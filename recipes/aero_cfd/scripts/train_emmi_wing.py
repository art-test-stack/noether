...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Train aerodynamic models on Emmi Wing dataset.")
    parser.add_argument("--dataset-root", required=True, help="Path to the Emmi Wing dataset.")
